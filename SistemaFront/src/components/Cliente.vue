...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "Nuevo Cliente" : "Actualizar Datos de Cliente";
    },
  },
  ...
  methods: {
    listar() {
      ...
      axios
        .get("api/Persona/ListarClientes",configuracion) //Listar Clientes
    ...
    GuardarRegistro() {
      ...
      if (this.editedIndex > -1) {
        ...
        let configuracion= {headers : header};
        axios
          .post("api/Persona/Crear", { //Crear cliente
            'tipo_persona':'Cliente',
            'nombre':guardar.nombre,
            'tipo_documento':guardar.tipo_documento,
            'num_documento':guardar.num_documento,
